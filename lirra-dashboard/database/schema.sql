-- ================================================
-- Lirra Dashboard Database Schema
-- Complete SQL schema for all dashboard features
-- ================================================

-- ==================== Core Tables ====================

-- Dashboard Users (created after token redemption)
...
-- Store Roles (for team management - Enterprise only)
